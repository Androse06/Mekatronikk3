...
class Metaclass_Route(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ngc_interfaces.msg import Waypoint
...
class Route(metaclass=Metaclass_Route):
    ...
    _fields_and_field_types = {
        'route_name': 'string',
        'waypoints': 'sequence<ngc_interfaces/Waypoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ngc_interfaces', 'msg'], 'Waypoint')),  # noqa: E501
    )
