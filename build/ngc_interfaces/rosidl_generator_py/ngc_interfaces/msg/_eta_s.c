...
bool ngc_interfaces__msg__eta__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ngc_interfaces.msg._eta.Eta", full_classname_dest, 27) == 0);
  }
  ngc_interfaces__msg__Eta * ros_message = _ros_message;
  {  // lat
...
{
  /* NOTE(esteve): Call constructor of Eta */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ngc_interfaces.msg._eta");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Eta");
