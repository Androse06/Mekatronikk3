...
#include "ngc_interfaces/msg/detail/hmi__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ngc_interfaces::msg::HMI & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ngc_interfaces::msg::HMI & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ngc_interfaces::msg::HMI;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ngc_interfaces::msg::HMI *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ngc_interfaces::msg::HMI *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HMI__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ngc_interfaces::msg::HMI *>(
...
static size_t _HMI__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HMI(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HMI__callbacks = {
  "ngc_interfaces::msg",
  "HMI",
  _HMI__cdr_serialize,
...
static rosidl_message_type_support_t _HMI__handle = {
...
{
  return &ngc_interfaces::msg::typesupport_fastrtps_cpp::_HMI__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ngc_interfaces, msg, HMI)() {
  return &ngc_interfaces::msg::typesupport_fastrtps_cpp::_HMI__handle;
}
