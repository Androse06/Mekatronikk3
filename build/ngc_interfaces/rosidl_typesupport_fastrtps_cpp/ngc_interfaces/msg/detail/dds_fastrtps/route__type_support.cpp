...
#include "ngc_interfaces/msg/detail/route__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ngc_interfaces::msg::Waypoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ngc_interfaces::msg::Waypoint &);
...
cdr_serialize(
  const ngc_interfaces::msg::Route & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ngc_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ngc_interfaces::msg::Route & ros_message)
{
  // Member: route_name
  cdr >> ros_message.route_name;
  ...
  // Member: waypoints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ngc_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ngc_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ngc_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
  ...
  if (is_plain) {
    ...
    using DataType = ngc_interfaces::msg::Route;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: waypoints
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      ngc_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.waypoints[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ngc_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.waypoints[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ngc_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ngc_interfaces::msg::Route *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ngc_interfaces::msg::Route *>(
    untyped_ros_message);
...
{
  return &ngc_interfaces::msg::typesupport_fastrtps_cpp::_Route__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ngc_interfaces, msg, Route)() {
  return &ngc_interfaces::msg::typesupport_fastrtps_cpp::_Route__handle;
}
