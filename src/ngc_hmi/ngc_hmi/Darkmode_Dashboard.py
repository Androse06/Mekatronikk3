...
"color: rgb(240, 240, 240);")
        ...
        sizePolicy1.setHeightForWidth(self.Enable_Track_Button.sizePolicy().hasHeightForWidth())
        self.Enable_Track_Button.setSizePolicy(sizePolicy1)
...
"")
        ...
        self.gridLayout_24.addWidget(self.Enable_Track_Button, 3, 1, 1, 1, Qt.AlignHCenter)

        self.verticalSpacer_19 = QSpacerItem(20, 15, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_24.addItem(self.verticalSpacer_19, 5, 1, 1, 1)

        self.horizontalSpacer_20 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_24.addItem(self.horizontalSpacer_20, 10, 2, 1, 1)

        self.Track_Status_Icon = QProgressBar(self.frame_7)
        self.Track_Status_Icon.setObjectName(u"Track_Status_Icon")
        sizePolicy1.setHeightForWidth(self.Track_Status_Icon.sizePolicy().hasHeightForWidth())
        self.Track_Status_Icon.setSizePolicy(sizePolicy1)
...
" }")
        ...
        self.gridLayout_24.addWidget(self.Track_Status_Icon, 4, 1, 1, 1, Qt.AlignHCenter)

        self.verticalSpacer_9 = QSpacerItem(10, 5, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_24.addItem(self.verticalSpacer_9, 8, 1, 1, 1)

        self.horizontalSpacer_19 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_24.addItem(self.horizontalSpacer_19, 10, 0, 1, 1)
        ...
        self.gridLayout_24.addWidget(self.Waypoints_Label, 9, 1, 1, 1)
        ...
        self.gridLayout_24.addWidget(self.Track_Label, 0, 1, 1, 1)

        self.Track_Load_Button = QPushButton(self.frame_7)
        self.Track_Load_Button.setObjectName(u"Track_Load_Button")
        sizePolicy1.setHeightForWidth(self.Track_Load_Button.sizePolicy().hasHeightForWidth())
        self.Track_Load_Button.setSizePolicy(sizePolicy1)
...
"")
        ...
        self.gridLayout_24.addWidget(self.Track_Load_Button, 6, 1, 1, 1, Qt.AlignHCenter)

        self.verticalSpacer_16 = QSpacerItem(15, 15, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_24.addItem(self.verticalSpacer_16, 2, 1, 1, 1)

        self.verticalSpacer_23 = QSpacerItem(10, 10, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_24.addItem(self.verticalSpacer_23, 11, 1, 1, 1)

        self.WayPoint_ListView = QListView(self.frame_7)
        self.WayPoint_ListView.setObjectName(u"WayPoint_ListView")
        self.WayPoint_ListView.setFont(font)

        self.gridLayout_24.addWidget(self.WayPoint_ListView, 10, 1, 1, 1)
...
"border-radius: 10px;")
        ...
        self.Gloabl_Throttle1_Label_2.setFont(font2)
...
"")
        ...
        self.Global_Throttle2_Label.setFont(font2)
        ...
        self.Global_Throttle1rev_Status.setFont(font4)
...
"")
        ...
        self.Gloabl_Throttle1_Label_4.setFont(font5)
...
"border-radius: 8px;")
        ...
        self.frame_3.setMaximumSize(QSize(300, 364))
...
"color: rgb(240, 240, 240);")
        ...
        self.North_Label.setFont(font6)
        ...
        self.Compass_Dial.setMinimumSize(QSize(0, 0))
        ...
        self.gridLayout_8.addLayout(self.gridLayout_2, 4, 1, 1, 1)
...
"border-radius: 10px;")
        ...
        self.gridLayout_9.addWidget(self.label_6, 6, 1, 1, 1)
        ...
        self.Global_Speed_LCD.setFont(font8)
...
"")
        ...
        self.Mode = QTextBrowser(self.frame)
        self.Mode.setObjectName(u"Mode")
        self.Mode.setMinimumSize(QSize(120, 20))
        self.Mode.setMaximumSize(QSize(120, 20))
        self.Mode.setFont(font7)
        self.Mode.setMouseTracking(True)
        self.Mode.setAcceptDrops(True)
        self.Mode.setStyleSheet(u"QTextBrowser {\n"
"    border: 1px solid #F0F0F0; \n"
"    border-radius: 4px;                /* Rounded corners */\n"
"    background-color: transparent;\n"
"}\n"
"")
        self.Mode.setFrameShape(QFrame.Panel)
        self.Mode.setFrameShadow(QFrame.Raised)
        self.Mode.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.Mode.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.Mode.setReadOnly(True)

        self.gridLayout_9.addWidget(self.Mode, 6, 4, 1, 1)

        self.label_7 = QLabel(self.frame)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setFont(font7)

        self.gridLayout_9.addWidget(self.label_7, 7, 1, 1, 1)

        self.Fuel = QTextBrowser(self.frame)
        self.Fuel.setObjectName(u"Fuel")
        self.Fuel.setMinimumSize(QSize(120, 20))
        self.Fuel.setMaximumSize(QSize(120, 20))
        self.Fuel.setFont(font7)
        self.Fuel.setMouseTracking(True)
        self.Fuel.setAcceptDrops(True)
        self.Fuel.setStyleSheet(u"QTextBrowser {\n"
"    border: 1px solid #F0F0F0; \n"
"    border-radius: 4px;                /* Rounded corners */\n"
"    background-color: transparent;\n"
"}\n"
"")
        self.Fuel.setFrameShape(QFrame.Panel)
        self.Fuel.setFrameShadow(QFrame.Raised)
        self.Fuel.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.Fuel.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.Fuel.setReadOnly(True)

        self.gridLayout_9.addWidget(self.Fuel, 7, 4, 1, 1)
...
"border-radius: 8px;")
        ...
        self.gridLayout.addWidget(self.verticalFrame1, 3, 0, 1, 1)
...
"color: rgb(240, 240, 240);")
        ...
        self.gridLayout_22.addItem(self.verticalSpacer_12, 10, 1, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 6, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_22.addItem(self.verticalSpacer_4, 8, 1, 1, 1)

        self.Sail_Heading_Dial = QDial(self.frame_5)
        self.Sail_Heading_Dial.setObjectName(u"Sail_Heading_Dial")
        sizePolicy1.setHeightForWidth(self.Sail_Heading_Dial.sizePolicy().hasHeightForWidth())
        self.Sail_Heading_Dial.setSizePolicy(sizePolicy1)
        self.Sail_Heading_Dial.setMinimumSize(QSize(120, 120))
        font9 = QFont()
        font9.setStyleStrategy(QFont.PreferDefault)
        self.Sail_Heading_Dial.setFont(font9)
        self.Sail_Heading_Dial.setFocusPolicy(Qt.WheelFocus)
        self.Sail_Heading_Dial.setContextMenuPolicy(Qt.DefaultContextMenu)
        self.Sail_Heading_Dial.setAutoFillBackground(False)
        self.Sail_Heading_Dial.setStyleSheet(u"QDial {\n"
"    background-color: #f0f0f0;  /* Background color */\n"
"    border: 2px solid #f97f55;  /* Border color and width */\n"
"    border-radius: 25px;  /* Make sure it\u2019s round */\n"
"}\n"
"\n"
"\n"
"")
        ...
        self.Sail_Heading_Dial.setTracking(True)
        self.Sail_Heading_Dial.setInvertedAppearance(False)
        self.Sail_Heading_Dial.setInvertedControls(False)
        self.Sail_Heading_Dial.setWrapping(True)
        self.Sail_Heading_Dial.setNotchesVisible(True)

        self.gridLayout_22.addWidget(self.Sail_Heading_Dial, 9, 1, 1, 1, Qt.AlignHCenter)

        self.Sail_Heading_LCD = QLCDNumber(self.frame_5)
        self.Sail_Heading_LCD.setObjectName(u"Sail_Heading_LCD")
        sizePolicy1.setHeightForWidth(self.Sail_Heading_LCD.sizePolicy().hasHeightForWidth())
        self.Sail_Heading_LCD.setSizePolicy(sizePolicy1)
...
"")
        ...
        self.gridLayout_22.addWidget(self.Sail_Heading_LCD, 12, 1, 1, 1, Qt.AlignHCenter)

        self.label_8 = QLabel(self.frame_5)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setFont(font)

        self.gridLayout_22.addWidget(self.label_8, 7, 3, 1, 1, Qt.AlignHCenter)

        self.verticalSpacer_21 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_22.addItem(self.verticalSpacer_21, 13, 1, 1, 1)

        self.verticalSpacer_14 = QSpacerItem(20, 15, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_22.addItem(self.verticalSpacer_14, 2, 1, 1, 1)
        ...
        self.gridLayout_22.addWidget(self.line_4, 1, 1, 1, 3, Qt.AlignHCenter)

        self.label_4 = QLabel(self.frame_5)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setFont(font)

        self.gridLayout_22.addWidget(self.label_4, 7, 1, 1, 1, Qt.AlignHCenter)

        self.horizontalSpacer_17 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_22.addItem(self.horizontalSpacer_17, 9, 0, 1, 1)
...
"}")
        ...
        self.Sail_Throttle_Slider.setMaximum(45)
        self.Sail_Throttle_Slider.setSingleStep(1)
        self.Sail_Throttle_Slider.setPageStep(1)
        self.Sail_Throttle_Slider.setValue(0)
        self.Sail_Throttle_Slider.setSliderPosition(0)
        self.Sail_Throttle_Slider.setOrientation(Qt.Vertical)
        self.Sail_Throttle_Slider.setInvertedControls(False)
        self.Sail_Throttle_Slider.setTickPosition(QSlider.TicksBothSides)
        self.Sail_Throttle_Slider.setTickInterval(10)

        self.gridLayout_22.addWidget(self.Sail_Throttle_Slider, 9, 3, 1, 1, Qt.AlignHCenter)
        ...
        self.gridLayout_22.addWidget(self.Sail_Label, 0, 1, 1, 3)

        self.Sail_Throttle_LCD = QLCDNumber(self.frame_5)
        self.Sail_Throttle_LCD.setObjectName(u"Sail_Throttle_LCD")
        sizePolicy1.setHeightForWidth(self.Sail_Throttle_LCD.sizePolicy().hasHeightForWidth())
        self.Sail_Throttle_LCD.setSizePolicy(sizePolicy1)
...
"")
        ...
        self.gridLayout_22.addWidget(self.Sail_Throttle_LCD, 12, 3, 1, 1, Qt.AlignHCenter)

        self.horizontalSpacer_18 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_22.addItem(self.horizontalSpacer_18, 9, 4, 1, 1)

        self.Enable_Sail_Button = QPushButton(self.frame_5)
        self.Enable_Sail_Button.setObjectName(u"Enable_Sail_Button")
        sizePolicy1.setHeightForWidth(self.Enable_Sail_Button.sizePolicy().hasHeightForWidth())
        self.Enable_Sail_Button.setSizePolicy(sizePolicy1)
...
"")
        ...
        self.gridLayout_22.addWidget(self.Enable_Sail_Button, 3, 1, 1, 3, Qt.AlignHCenter|Qt.AlignVCenter)

        self.Sail_Status_Icon = QProgressBar(self.frame_5)
        self.Sail_Status_Icon.setObjectName(u"Sail_Status_Icon")
        sizePolicy1.setHeightForWidth(self.Sail_Status_Icon.sizePolicy().hasHeightForWidth())
        self.Sail_Status_Icon.setSizePolicy(sizePolicy1)
...
" }")
        ...
        self.gridLayout_22.addWidget(self.Sail_Status_Icon, 7, 2, 1, 1)
...
"color: rgb(240, 240, 240);  /*background-color: rgb(44, 44, 44);")
        ...
        sizePolicy1.setHeightForWidth(self.Enable_Standby_Button.sizePolicy().hasHeightForWidth())
        self.Enable_Standby_Button.setSizePolicy(sizePolicy1)
...
"")
        ...
        sizePolicy1.setHeightForWidth(self.Standby_Status_Icon.sizePolicy().hasHeightForWidth())
        self.Standby_Status_Icon.setSizePolicy(sizePolicy1)
...
"")
        ...
        self.Deviation_Dp_LCD.setSizePolicy(sizePolicy1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Fuel:", None))
        ...
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Thrust", None))
