...
class Estimator(Node):
    ...
    def __init__(self):
        ...
        self.heading_measurement    = np.zeros(3)
    ...
    def step_estimator(self):
        ...
        if self.pos_meas_init and self.heading_meas_init:
            ...
            if self.gnss_valid:
                ...
                eta_tilde[0], eta_tilde[1] = geo.calculate_distance_north_east(self.lat_hat, self.lon_hat, self.gnss_measurement[0], self.gnss_measurement[1])
