...
static const _GNSS_type_support_symbol_names_t _GNSS_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ngc_interfaces, msg, GNSS)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ngc_interfaces, msg, GNSS)),
  }
};
...
{
  return &::ngc_interfaces::msg::rosidl_typesupport_cpp::GNSS_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ngc_interfaces, msg, GNSS)() {
  return get_message_type_support_handle<ngc_interfaces::msg::GNSS>();
}
