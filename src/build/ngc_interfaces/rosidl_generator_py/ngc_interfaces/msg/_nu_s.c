...
bool ngc_interfaces__msg__nu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ngc_interfaces.msg._nu.Nu", full_classname_dest, 25) == 0);
  }
  ngc_interfaces__msg__Nu * ros_message = _ros_message;
  {  // u
...
{
  /* NOTE(esteve): Call constructor of Nu */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ngc_interfaces.msg._nu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Nu");
