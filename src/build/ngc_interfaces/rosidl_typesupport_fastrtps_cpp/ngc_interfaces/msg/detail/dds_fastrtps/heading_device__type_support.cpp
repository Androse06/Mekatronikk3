...
#include "ngc_interfaces/msg/detail/heading_device__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ngc_interfaces::msg::HeadingDevice *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ngc_interfaces::msg::HeadingDevice *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HeadingDevice__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ngc_interfaces::msg::HeadingDevice *>(
...
static size_t _HeadingDevice__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HeadingDevice(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HeadingDevice__callbacks = {
  "ngc_interfaces::msg",
  "HeadingDevice",
...
static rosidl_message_type_support_t _HeadingDevice__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HeadingDevice__callbacks,
...
{
  return &ngc_interfaces::msg::typesupport_fastrtps_cpp::_HeadingDevice__handle;
}
